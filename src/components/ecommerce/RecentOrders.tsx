...
export default function RecentOrders({ rawRecords, isSimple }) {
  ...
  return (
    <div className=" border border-gray-200 bg-white px-4 pb-3 pt-4 dark:border-gray-800 dark:bg-white/[0.03] sm:px-6">
      ...
      <div className=" overflow-auto h-80 custom-scrollbar overflow-x-auto
      ">
        <Table>
          {/* Table Header */}
